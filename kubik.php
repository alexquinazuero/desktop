...
/**
 * @Author: Alex Quin Azuero
 * @Date:   2018-08-11 17:01:26
 * @Last Modified by:   Magic LerNT
 * @Last Modified time: 2018-08-20 19:05:24
*/


##############################################################################################################
$config['deviceCode'] 		= '869269023564140';
$config['tk'] 				= 'ACGNcp3NUwxGKInyGCCrevMJ3z0Kck7aTURxdHRodw';
$config['token'] 			= 'fd5bwU1Aodonyyv2uFCLd0vXvo-cNn0Fx_KcGLBOQT0a-5p562bj8PlNUm_nthS5QfWHlW38vdxBJLI';
$config['uuid'] 			= '137212a286c74c82bdf7f399125b561f';
$config['sign'] 			= '03384f59e1cc2ba760a0a14074339cc9';
$config['android_id'] 		= 'a71f746d1d5c71d5';
##############################################################################################################
